...
#define DEFINE_TIMER_DEV(_tmr_no, _irq)			\
	.name		= "s3c24xx-pwm",		\
	.id		= _tmr_no,			\
...
struct platform_device s3c_device_timer[] = {
	[0] = { DEFINE_TIMER_DEV(0, IRQ_TIMER0) },
	[1] = { DEFINE_TIMER_DEV(1, IRQ_TIMER1) },
	[2] = { DEFINE_TIMER_DEV(2, IRQ_TIMER2) },
	[3] = { DEFINE_TIMER_DEV(3, IRQ_TIMER3) },
	[4] = { DEFINE_TIMER_DEV(4, IRQ_TIMER4) },
};
